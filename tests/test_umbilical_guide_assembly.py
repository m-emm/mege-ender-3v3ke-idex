...
UMBILICAL_GUIDE_PARAMETERS = {
    "x_axis_umbilical_guide_radius": DEFAULTS["x_axis_umbilical_guide_radius"],
    "x_axis_umbilical_guide_cable_diameter": DEFAULTS[
        "x_axis_umbilical_guide_cable_diameter"
    ],
    "x_axis_umbilical_guide_inner_width": DEFAULTS[
        "x_axis_umbilical_guide_inner_width"
    ],
    "x_axis_umbilical_guide_wall_thickness": DEFAULTS[
        "x_axis_umbilical_guide_wall_thickness"
    ],
    "x_axis_umbilical_guide_depth": DEFAULTS["x_axis_umbilical_guide_depth"],
}
...
def test_umbilical_guide_stacks_on_top_of_x_axis_top_profile():
    ...
    top_profile = create_x_axis_profile_assembly(
        ...
        x_axis_profile_length=DEFAULTS["x_axis_profile_length"],
    )
    ...
    placed_guide = align(
        ...
        top_profile.leader,
        Alignment.STACK_TOP,
        stack_gap=DEFAULTS["x_axis_umbilical_guide_stack_gap"],
    )
    ...
    assert guide_bbox[0][2] == pytest.approx(
        profile_bbox[1][2] + DEFAULTS["x_axis_umbilical_guide_stack_gap"]
    )
