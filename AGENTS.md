...
- `toolhead_nitehawk_and_x_axis.cfg` - Main config with Nitehawk 36 toolhead board and X-axis stepper
- `x_axis_stepper_endstop_pico_w.cfg` - Separate X-axis MCU configuration
