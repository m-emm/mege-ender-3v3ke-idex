...
tool_head_mount_carriage_mount_plate_width = 80
tool_head_mount_carriage_mount_l_profile_thickness = 3.2
tool_head_mount_carriage_mount_l_profile_outer_size = 30
...
x_axis_umbilical_guide_radius = 100
x_axis_umbilical_guide_cable_diameter = 5.25
x_axis_umbilical_guide_inner_width = 5
x_axis_umbilical_guide_wall_thickness = 1
x_axis_umbilical_guide_depth = 8
x_axis_umbilical_guide_stack_gap = 0
...
mount_plate_connector_length = z_axis_guide_distance - 2 * motor_x_offset - 42.3 + 8
