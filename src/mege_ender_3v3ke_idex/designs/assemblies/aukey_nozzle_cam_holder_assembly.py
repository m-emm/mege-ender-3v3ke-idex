...
def create_aukey_nozzle_cam_holder_assembly(
    *,
    ...
    core_base_plate_depth =  camera_size[1] + 4 * aukey_nozzle_cam_holder_base_plate_margin
    ...
    base_plate_right_extension = align(base_plate_right_extension, base_plate, Alignment.CENTER)
    base_plate_right_extension = align(base_plate_right_extension, base_plate, Alignment.STACK_RIGHT)

    base_plate_right_extension = fit_part_between(base_plate_right_extension, cut_normal=(1,0,0), limiting_start_part = base_plate, limiting_end_part= right_profile)
    ...
    mount_plate_height = profile_bbox[1][2] - mount_plate_top_clearance - base_plate_bbox[0][2]
    ...
    for i in [0,1]  :
        ...
        m5_hole = translate(0, i * (core_base_plate_depth - 2 * aukey_nozzle_cam_holder_base_plate_margin), 0)(m5_hole)
    ...
    camera_cutout = materialize_bounding_box(nozzle_cam, x_enlargement=wall_clearance, y_enlargement=wall_clearance)
    ...
    for lr in [Alignment.LEFT, Alignment.RIGHT]:
        for fb in [Alignment.FRONT, Alignment.BACK]:
            ...
            slit = translate(-lr.sign* fix_slit_x_inset, -fb.sign * fix_slit_y_inset, 0)(slit)
