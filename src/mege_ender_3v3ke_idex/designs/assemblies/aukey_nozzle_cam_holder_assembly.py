...
def create_aukey_nozzle_cam_holder_assembly(
    *,
    ...
    bottom_mount_plate = align(
        bottom_mount_plate, right_profile, Alignment.STACK_BOTTOM
    )
    ...
    enhancement_dome = align(
        enhancement_dome, base_plate_with_extension, Alignment.CENTER
    )
    enhancement_dome = align(
        enhancement_dome, base_plate_with_extension, Alignment.RIGHT
    )
    enhancement_dome_cutter = create_box(500, 500, 500)
    enhancement_dome_cutter = align(
        enhancement_dome_cutter, base_plate_with_extension, Alignment.CENTER
    )
    enhancement_dome_cutter = align(
        enhancement_dome_cutter, base_plate_with_extension, Alignment.TOP
    )
