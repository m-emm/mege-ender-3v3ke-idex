...
SOURCE_CFG="${SCRIPT_DIR}/pico_w_btt_tmc2226_y_axis_bringup.cfg"
...
echo "Installing Y-axis Pico bring-up Klipper configuration..."
...
echo "  3. In Mainsail, run Y_TEST_ENABLE, Y_TEST_BUZZ, then Y_TEST_HOME"
echo ""
