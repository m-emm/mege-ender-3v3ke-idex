...
def split_boosted_heater_power(value, primary_power, boost_power):
    ...
    boost_pwm = max(0., requested_power - primary_power) / boost_power
    return primary_pwm, min(boost_pwm, 1.)
...
class BoostedHeaterPwmOutput:
    def __init__(self, primary_pwm, boost_pwm, primary_power, boost_power):
        ...
        self.last_primary_pwm = 0.
        self.last_boost_pwm = 0.
    def get_mcu(self):
...
class Heater:
    def __init__(self, config, sensor):
        ...
        if boost_pin is None:
            ...
            primary_power = config.getfloat('primary_heater_power', above=0.)
            boost_power = config.getfloat('boost_heater_power', above=0.)
